This library package holds definitions of the model data that is common between the front-end (ui) and back-end (service) for Reader Team Management (eca-rtm-*).  
